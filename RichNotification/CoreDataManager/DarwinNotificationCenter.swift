...
public final class DarwinNotificationCenter {
    ...
    private let queue = DispatchQueue(label: "group.com.debashish.notificationrich", qos: .default, attributes: [], autoreleaseFrequency: .workItem)
...
extension DarwinNotification.Name {
    ...
    private static var extensionDidSaveManagedObjectContext: DarwinNotification.Name {
        return DarwinNotification.Name("group.com.debashish.notificationrich")
    }
